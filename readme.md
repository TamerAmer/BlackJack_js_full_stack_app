...
MVP
Create a browser game based on Blackjack. Model the game logic and then display it in the browser for a user to interact with.
...
1. Go into the server folder and run the seeds file: npm run seeds
2. In the server folder start the server: npm start server:dev
3. Go into the client folder: npm start app
